/*
 * File_name: 123-avl_remove.c
 * Task_no: 33
 * Task_Title: 33. AVL-Remove
 *
 * Functions: avl_t *avl_remove, void bal,
 *            int successor, int remove_type,
 *            bst_t *bst_remove.
...
/**
 * successor - get the next successor i mean the
