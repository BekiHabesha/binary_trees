/*
 * File_name: 133-heap_extract.c
 * Task_no: 39
 * Task_Title: 39. Heap-Extract
 *
 * Functions: int heap_extract, void _preorder,
 *            size_t tree_height, void heapify,
 *            size_t tree_size_h.
...
/**
 * tree_size_h - measures the sum of heights
 *               of a binary tree
 *
 * Author: Bereket Dereje Mekonnen.
 *
